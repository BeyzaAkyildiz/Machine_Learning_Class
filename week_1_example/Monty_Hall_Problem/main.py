# Monty Hall Problem Çözümü
import random
# random olarak işaretli ve seçilmiş kapıyı seçilmesi
isaretli = random.randint(0, 2)
secilmis = random.randint(0, 2)
temp = 0
sonuc = 0
# ilk seçimin seçilip kazanma hesabı
for x in range(1000):
    isaretli = random.randint(0, 2)
    secilmis = random.randint(0, 2)
...
tempp = 0
hesap = 0
# seçimin değiştirilme kazanma durumu hesabı
